...
public class PaymentUtil {
    ...
    private static final String sUrl = "http://localhost:5000/payment/payment-response";

    private static final String fUrl = "http://localhost:5000/payment/payment-response";
